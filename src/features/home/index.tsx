  ...
  return (
    <div className="px-4 md:px-4 md:pt-6">
          ...
          <CardBody>
            <div className="flex items-center gap-4">
              <div className="relative">
                <div className="border border-2 border-primary rounded-full">
                  <img
      ...
      <div className="flex gap-4 mt-4">
        <Card className="w-1/2 h-[60vh]">
          <CardBody className="flex flex-col items-start gap-4 hover:bg-gray-50 transition duration-300 p-8 pb-14">
